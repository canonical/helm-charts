> [!NOTE]
> This chart is a fork of the [Bitnami Common Library Chart](https://github.com/bitnami/charts/tree/main/bitnami/common),
> adapted for use with Canonical's Helm charts and container images.

# Common Library Chart

A [Helm Library Chart](https://helm.sh/docs/topics/library_charts/#helm) for grouping common logic between Canonical Helm charts.
...
dependencies:
  - name: common
    version: 0.x.x
    repository: oci://ghcr.io/canonical/helm-charts
```
...
# registry: docker.io
# repository: ubuntu/nginx
# tag: 1.24-24.04_stable
...
This chart is based on the [Bitnami Common Library Chart](https://github.com/bitnami/charts/tree/main/bitnami/common),
